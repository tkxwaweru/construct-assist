  ...
  <div class="container">
    <nav>
      <div class="side_navbar">
        ...
        <a  class="active"  href="<?php echo site_url('verifyProviders'); ?>">Submit Verification Documentation</a>
        <a    href="<?php echo site_url('ratings'); ?>">Ratings</a><a class="log-out-button" href="<?php echo site_url('logout'); ?>">Logout</a>
      </div>
    </nav>
